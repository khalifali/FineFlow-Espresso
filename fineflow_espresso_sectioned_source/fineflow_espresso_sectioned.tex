...
{\small\color{tumblue}Constant 9 bar across puck + basket. Exponential permeability.}\par\medskip
 \begin{columns}[T,onlytextwidth]
  ...
  \column{.30\textwidth}{\small
   ...
   \item flow: 0.0447 mL/s;
   \item minimum $K/K_0$: 0.0125.\end{itemize}
   \vspace{.25cm}
   \hi{Interpretation}
...
{\small\color{tumblue}Constant 9 bar across puck + basket. Exponential permeability.}\par\medskip
 \begin{columns}[T,onlytextwidth]
  ...
  \column{.35\textwidth}{\small
   ...
   \begin{itemize}\item puck outlet: 0.0619 g;
   \item basket retained: 0.0217 g;
   \item cup: 0.0402 g.\end{itemize}
   \vspace{.25cm}
...
\begin{columns}[T,onlytextwidth]
 \column{.66\textwidth}\centering
  ...
  \par\vspace{-.12cm}{\scriptsize\color{tumgray}Model $t=0$: start of saturated extraction; dry/preinfusion not modeled.}
 \column{.30\textwidth}\small
...
\centering\includegraphics[width=.94\linewidth,height=3.5cm,keepaspectratio]{fine_puck_hydraulics.pdf}
\par\small At 60 s: constant pressure gives $Q=0.0447$ mL/s; PI gives $Q=0.0454$ mL/s. The PI startup ramp changes the earlier fines history.
...
{\small\color{tumblue}Constant 9 bar vs.\ PI, 9 bar target. Exponential permeability.}\par\medskip
\centering\includegraphics[width=.94\linewidth,height=3.5cm,keepaspectratio]{coarse_puck_hydraulics.pdf}
\par\small Constant 9 bar initially requires 105 mL/s, above the PI cap of 10.83 mL/s. PI reaches only 1.66 bar at 2 s. Deposition later raises resistance enough to reach the target.
...
{\small\color{tumblue}Constant 9 bar vs.\ PI, 9 bar target. Exponential permeability.}\par\medskip
\begin{columns}[T,onlytextwidth]
\column{.65\textwidth}\includegraphics[width=\linewidth,height=3.6cm,keepaspectratio]{coarse_puck_fines.pdf}
...
\begin{columns}[c,onlytextwidth]
\column{.66\textwidth}\includegraphics[width=\linewidth,height=3.6cm,keepaspectratio]{comparison_flow.pdf}
...
{\small\color{tumblue}Flow-limited PI, 9 bar target. Exponential vs.\ Kozeny--Carman.}\par\medskip
\begin{columns}[c,onlytextwidth]
\column{.66\textwidth}\includegraphics[width=\linewidth,height=3.6cm,keepaspectratio]{comparison_permeability.pdf}
...
{\small\color{tumblue}Flow-limited PI, 9 bar target. Exponential vs.\ Kozeny--Carman.}\par\medskip
\begin{columns}[c,onlytextwidth]
\column{.66\textwidth}\includegraphics[width=\linewidth,height=3.6cm,keepaspectratio]{comparison_cup_fines.pdf}
