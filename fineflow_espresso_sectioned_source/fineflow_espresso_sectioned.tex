...
\hi{Fines migration changes the hydraulic response}
\begin{itemize}
\item Mobile fines can accumulate in the puck or leave with the water.
\item Deposition changes permeability and feeds back on pressure and flow.
\item Cup collection reveals only the fines that pass both puck and basket.
\end{itemize}
\medskip
\question{How do fines redistribution and washout change flow resistance and the fines reaching the cup?}
\medskip
\small The 1D model links proposed CT structural inputs to pressure, flow and fines measurements.
\end{frame}
...
\]
\hi{Structural closure: exponential, Kozeny--Carman or a PNM table}
\[
K(z,t)=K_0(z)\,f\!\left(m_d(z,t),\varepsilon(z,t)\right).
\]
...
\begin{frame}{The illustrative case develops strong viscous blockage}
 \begin{columns}[T,onlytextwidth]
  \column{.66\textwidth}{\centering\safeimage{hydraulic_response.png}{\linewidth}{4.3cm}}
...
\begin{frame}{The model distinguishes puck washout from fines in the cup}
 \begin{columns}[T,onlytextwidth]
  \column{.61\textwidth}{\centering\safeimage{fines_washout.png}{\linewidth}{4.3cm}}
...
\begin{frame}{The axial fields locate the effective blocking region}
 \begin{columns}[T,onlytextwidth]
  \column{.49\textwidth}{\centering\safeimage{deposited_fines.png}{\linewidth}{4.3cm}}
  \column{.49\textwidth}{\centering\safeimage{relative_permeability.png}{\linewidth}{4.3cm}}
 \end{columns}
 \vspace{.1cm}
