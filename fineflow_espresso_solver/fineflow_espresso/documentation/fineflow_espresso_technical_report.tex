...
The older \code{results/} directory is an archived run, identified by its own
parameter snapshot; it should not be described as a fresh run of the new defaults.
